...
//			}
	...
	@PutMapping("/users/{id}")
    public ResponseEntity<MyUser> updateCustomerDetails(@PathVariable Integer id,
                                                           @RequestBody MyUser userUpdateRequest) {
        try {
            MyUser user = userService.updateUserDetails(id, userUpdateRequest);
